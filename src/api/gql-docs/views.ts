...
export const viewDocs: DocMap = {
  ...
  ...Object.fromEntries(
    Object.entries(conditionalOrderGeneratorDocs)
      .filter(([key]) => key.startsWith("conditionalOrderGenerator."))
      .map(([key, description]) => [key.replace("conditionalOrderGenerator.", "programmaticOrder."), description]),
  ),
